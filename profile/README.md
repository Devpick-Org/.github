...
<table>
  <tr>
    ...
    <td width="33%" valign="top" align="center">
      ...
      <br />
      <sub>기술과 커리어 질문을 AI로 다듬고 첫 답변을 빠르게 제공</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top" align="center">
    ...
    <td width="33%" valign="top" align="center">
      ...
      <strong>모의면접</strong>
      <br />
      <sub>직무와 이력서 기반 질문으로 실전 면접 흐름을 연습</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top" align="center">
...
Confluence에는 PRD, 서비스 개요, 회의록, 설계 문서, 트러블슈팅 기록 등 프로젝트 진행 과정에서 작성한 주요 산출물을 정리해 두었습니다.
...
![Redis](https://img.shields.io/badge/Redis_ElastiCache-DC382D?style=for-the-badge&logo=redis&logoColor=white)
...
![Jacoco](https://img.shields.io/badge/Jacoco-5C8DBC?style=for-the-badge&logo=java&logoColor=white)
...
[시연영상 바로 보러가기](https://www.youtube.com/watch?v=WbdHGSQpq20)
